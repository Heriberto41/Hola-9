...
public class View_Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jmi_convercion = new javax.swing.JMenuItem();
        jmi_cifrado = new javax.swing.JMenuItem();
        ...
        jFile.setText("Archivos");

        jmi_acerca.setText("Acerca de");
        jFile.add(jmi_acerca);

        jmi_convercion.setText("Converciones");
        jFile.add(jmi_convercion);

        jmi_cifrado.setText("Cifrado");
        jFile.add(jmi_cifrado);

        jmi_imc.setText("IMC");
        jFile.add(jmi_imc);

        jmi_operaciones.setText("Operaciones");
        jFile.add(jmi_operaciones);
    ...
    public javax.swing.JMenuItem jmi_acerca;
    public javax.swing.JMenuItem jmi_cifrado;
    public javax.swing.JMenuItem jmi_convercion;
    public javax.swing.JMenuItem jmi_imc;
